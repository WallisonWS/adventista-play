                    ...
                    >
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-4 rounded-xl border border-white/10 bg-black/40 backdrop-blur-md shadow-lg focus:border-blue-500 focus:bg-white/15 focus:outline-none transition-all text-white placeholder:text-white/50"
                            />
                        </div>
                        ...
                        <div className="hidden md:flex gap-2 items-center overflow-x-auto pb-2 md:pb-0">
                            <button
                                ...
                                className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${selectedCategory === 'Todos'
                                    ...
                                    : 'bg-black/20 backdrop-blur-md hover:bg-black/40 border border-white/10 text-white'
                                    }`}
                            >
                                Todos
                            </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <AnimatePresence>
                        {filteredEstudos.map((estudo, index) => (
                            ...
                            >
                                <Card3D
                                    className="h-full cursor-pointer group bg-black/20 backdrop-blur-md border border-white/10 hover:border-blue-500/50"
