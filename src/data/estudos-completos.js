...
export const estudosCompletos = {
  ...
  estudosTematicos: [
    ...
    },
    {
      ...
      tipo: 'Estudos Temáticos',
      videoaulas: [
        { numero: 1, titulo: 'A Estátua e os Reinos', videoId: 'VIDEO_ID_1', duracao: '15 min' },
        { numero: 2, titulo: 'As 70 Semanas', videoId: 'VIDEO_ID_2', duracao: '12 min' },
        { numero: 3, titulo: 'O Santuário e a Purificação', videoId: 'VIDEO_ID_3', duracao: '18 min' },
        { numero: 4, titulo: 'O Chifre Pequeno', videoId: 'VIDEO_ID_4', duracao: '10 min' },
        { numero: 5, titulo: 'O Tempo do Fim', videoId: 'VIDEO_ID_5', duracao: '14 min' },
        { numero: 6, titulo: 'A Ressurreição', videoId: 'VIDEO_ID_6', duracao: '16 min' },
      ],
      licoes: [
  ...
  personagensBiblicos: [
    ...
    },
    {
      ...
      tipo: 'Personagens Bíblicos',
      videoaulas: [
        { numero: 1, titulo: 'O Sonhador e a Túnica', videoId: 'VIDEO_ID_1', duracao: '15 min' },
        { numero: 2, titulo: 'Vendido como Escravo', videoId: 'VIDEO_ID_2', duracao: '12 min' },
        { numero: 3, titulo: 'Fidelidade na Prisão', videoId: 'VIDEO_ID_3', duracao: '18 min' },
        { numero: 4, titulo: 'Do Cárcere ao Palácio', videoId: 'VIDEO_ID_4', duracao: '10 min' },
        { numero: 5, titulo: 'O Reencontro com os Irmãos', videoId: 'VIDEO_ID_5', duracao: '14 min' },
        { numero: 6, titulo: 'O Perdão e a Provisão', videoId: 'VIDEO_ID_6', duracao: '16 min' },
      ],
      licoes: [
  ...
  livrosBiblia: [
    ...
    },
    {
      ...
      tipo: 'Livros da Bíblia',
      videoaulas: [
        { numero: 1, titulo: 'O Verbo se Fez Carne', videoId: 'VIDEO_ID_1', duracao: '15 min' },
        { numero: 2, titulo: 'As Bodas de Caná', videoId: 'VIDEO_ID_2', duracao: '12 min' },
        { numero: 3, titulo: 'O Encontro com Nicodemos', videoId: 'VIDEO_ID_3', duracao: '18 min' },
        { numero: 4, titulo: 'A Mulher Samaritana', videoId: 'VIDEO_ID_4', duracao: '10 min' },
        { numero: 5, titulo: 'A Ressurreição de Lázaro', videoId: 'VIDEO_ID_5', duracao: '14 min' },
        { numero: 6, titulo: 'A Última Ceia e o Lava-pés', videoId: 'VIDEO_ID_6', duracao: '16 min' },
      ],
      licoes: [
